...
public class InventorySlot
{
    ...
    public bool EnoughRoomLeftInStack(int amountToAdd, out int amountRemaining) // Would there the be enough room in the stack fot the amount we're trying to add
    {
